...
const REVIEWS = [
  ...
  { name: "Chú Thành", age: 64, loc: "Bình Dương",combo: "Combo 2 Chai PestShield",  avatar: "/chuthanh.webp", rating: 4, photo: "/chuthanhmin.webp", text: "Xịt PestShield xong sáng hôm sau gom được cả đống muỗi bị diệt — thấy mà mừng! Trước tốn mấy trăm gọi dịch vụ phun mà chỉ hiệu quả 1–2 tháng. Giờ tự làm được, tiết kiệm hơn nhiều." },
      ...
      <main>
            ...
            >
              {REVIEWS.map((t, i) => (
                <div key={i} className="snap-start flex-shrink-0 w-[88vw] max-w-[340px] bg-white rounded-2xl overflow-hidden border border-slate-200 shadow-sm">
                  ...
                  {t.photo ? (
                    <img src={t.photo} alt="Ảnh thực tế khách hàng dùng PestShield tại nhà" className="w-full aspect-square object-cover object-center" loading="lazy" width={600} height={450} sizes="(max-width: 640px) 88vw, 340px" />
                  ) : (
        ...
        <section className="py-8 md:py-10 bg-gradient-to-b from-teal-50 to-emerald-50 border-t border-emerald-100">
          <div className="max-w-lg mx-auto px-4 text-center">
            <h2 className="text-2xl md:text-3xl font-black text-slate-900 leading-tight mb-5 md:whitespace-nowrap">
              🇪🇺 Chứng Nhận An Toàn Hoá Chất Châu Âu
            </h2>
            <img
              src="/chungnhan.webp"
