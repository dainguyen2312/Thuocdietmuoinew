...
const REVIEWS = [
  ...
  { name: "Chú Thành", age: 64, loc: "Bình Dương",combo: "Combo 2 Chai PestShield",  avatar: "/chuthanhmin.webp", rating: 4, photo: "/rv6.webp", text: "Xịt PestShield xong sáng hôm sau gom được cả đống muỗi chết — thấy mà mừng! Trước tốn mấy trăm gọi dịch vụ phun mà chỉ hiệu quả 1–2 tháng. Giờ tự làm được, tiết kiệm hơn nhiều." },
  { name: "Chị Nga",   age: 47, loc: "Đồng Nai",  combo: "1 Chai PestShield", avatar: "/chingamin.webp",   rating: 5, photo: "/rv7.webp", text: "Xịt xong sáng ra gom lại cả mớ muỗi chết, không ngờ nhiều vậy! Nhà có 2 con mèo nên tôi rất cẩn thận, nhưng PestShield an toàn thật — cho mèo vào lại sau 30 phút, không sao cả." },
